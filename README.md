...
in a multi-sector ETF portfolio, and benchmarks it against the broad market. 


## Objective
Evaluate whether a sample investment portfolio is balanced between
...
## Tableau: 
https://public.tableau.com/views/InvestmentPortfolioRiskandReturnAnalysisDashboard/Dashboard1?:language=en-US&publish=yes&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link
...
a year, using the NYSE calendar. The daily growth factors are multiplied together to get the total growth over the period,
...
A risk-free rate of 2% is assumed as a reasonable average. Higher Sharpe values indicate better compensation for the risk
taken.
...
Excess return is each entity's annualized return minus SPY's, and entities are flagged Outperform or
Underperform accordingly.

### Technology stack

The pipeline runs across three layers: **Python / pandas** pulls the data and
